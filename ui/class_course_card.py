...
################################################################################
## Form generated from reading UI file 'class_course_card.ui'
##
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.BodyLabel.setText(QCoreApplication.translate("Form", u"Course2", None))
        self.BodyLabel_2.setText(QCoreApplication.translate("Form", u"Yoga Class 2.  Required points 20", None))
        self.PushButton_2.setText(QCoreApplication.translate("Form", u"Buy", None))
    # retranslateUi
