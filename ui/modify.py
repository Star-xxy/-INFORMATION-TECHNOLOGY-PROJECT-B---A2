...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(440, 386)
        self.verticalLayout = QVBoxLayout(Dialog)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(60, 9, 60, -1)
        ...
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.BodyLabel_3)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.TitleLabel.setText(QCoreApplication.translate("Dialog", u"Modification information", None))
        ...
        self.BodyLabel_3.setText(QCoreApplication.translate("Dialog", u"Weight", None))
        self.BodyLabel_7.setText(QCoreApplication.translate("Dialog", u" kg    ", None))
        self.PrimaryPushButton.setText(QCoreApplication.translate("Dialog", u"Confirm", None))
