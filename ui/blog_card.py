...
################################################################################
## Form generated from reading UI file 'blog_card.ui'
##
...
from qfluentwidgets import (BodyLabel, CaptionLabel, CardWidget, ImageLabel,
    PushButton)
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.BodyLabel.setText(QCoreApplication.translate("Form", u"Auther", None))
        self.PushButton_3.setText(QCoreApplication.translate("Form", u"Add friend", None))
        self.BodyLabel_2.setText(QCoreApplication.translate("Form", u"content", None))
        self.CaptionLabel.setText(QCoreApplication.translate("Form", u"2025/4/1", None))
        self.PushButton.setText(QCoreApplication.translate("Form", u"Like", None))
        self.PushButton_2.setText(QCoreApplication.translate("Form", u"Collect", None))
    # retranslateUi
